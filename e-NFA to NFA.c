...
void main() {
    printf("Steps to convert epsilon-NFA to NFA and find epsilon closure:\n");
    printf("----------------------------------------------------------\n");
    ...
    printf("NOTE: Transition is in the form: state1 <space> alphabet <space> state2\n");
    printf("NOTE: State numbers must be greater than zero\n");

    printf("Enter transitions (state1 <space> alphabet <space> state2): \n");
    ...
    printf("Epsilon Closures of states:\n");
    printf("----------------------------\n");
    for (i = 1; i <= nostate; i++) {
